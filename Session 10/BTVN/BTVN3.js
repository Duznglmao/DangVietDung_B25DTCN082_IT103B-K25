...
function getFilteredTotalGoals(minGoals, players) {
    if (!Array.isArray(players) || isNaN(minGoals)) {
        console.log("Dữ liệu không hợp lệ");
        return;
    }

    const filteredPlayers = players.filter(player => player.goals >= minGoals);
